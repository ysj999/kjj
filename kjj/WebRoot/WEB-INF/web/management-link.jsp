...
<c:forEach items="${vlist}" var="v">
        <tr> 
        <td><input name="checkbox" type="checkbox" value="${v.id}" id="checkbox1" /></td>
        <td>${v.name}</td>
        <td>${v.address}</td>
        <td><a href="#">查看</a></td>
        <td><a href="#">修改</a></td>
  ...
  <div class="clear"></div>
      ...
      <a href="#">&lt;&lt;</a><a href="#">1</a><a href="#">2</a><a href="#">3</a><a href="#">4</a><a href="#">5</a><a href="#">6</a><a href="#">7</a><a href="#">8</a><a href="#">9</a><a href="#">10</a>...<a href="#">100</a><a href="#">101</a><a href="#">&gt;&gt;</a>
				...
				<div class="hide">
                    <ul>
            <form>
           <label>链接名称：</label><br /><input type="text" class="input" /> <br />
           <label>链接地址:</label><br /><input type="text" class="input" /><br />
